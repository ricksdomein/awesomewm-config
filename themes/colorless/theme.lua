...
function theme:init()
	...
	----------------------------------------------------------
	self.gauge.icon.battery = {
		icon        = {full = self.icon.system, unknown = self.icon.system, charged = self.icon.system, charging = self.icon.system, discharging = self.icon.system},  -- default icon
		is_vertical = false,             -- use vertical gradient (horizontal if false)
		step        = 0.02,              -- icon painting step
		color       = self.color         -- colors (main used)
	}
