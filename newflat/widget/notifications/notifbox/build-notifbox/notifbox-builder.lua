...
local builder = require('newflat.widget.notifications.notifbox.build-notifbox.notifbox-ui-elements')
local notifbox_core = require('newflat.widget.notifications.notifbox.build-notifbox')
...
notifbox_box = function(notif, icon, title, message, app, bgcolor)
	...
	-- 	'mouse::enter',
	-- 	function()
	-- 		notifbox.bg = beautiful.color.main
	-- 		notifbox_template.fg = beautiful.color.wibox
	...
	-- 		notifbox_template.fg = beautiful.color.text
