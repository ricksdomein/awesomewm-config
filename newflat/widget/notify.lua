...
local function default_style()
	local style = {
		...
		set_position    = function(wibox)
			wibox:geometry({ x = mouse.screen.workarea.x + (mouse.screen.workarea.width/2) - 100, y = mouse.screen.workarea.y})
		end,
		border_margin   = { 10, 10, 5, 5 },
		elements_margin = { 15, 0, 5, 5 },
		bar_width       = 8,
		font            = "Sans 14",
		border_width    = 0,
		timeout         = 1,
	...
	return redutil.table.merge(style, redutil.table.check(beautiful, "audio.notify") or {})
end
